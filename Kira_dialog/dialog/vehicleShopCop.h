...
class Life_Vehicle_Shop_Cop
{
	...
	class controlsBackground
	{
		...
		class RentCar : Life_RscButtonMenu
		{
			...
			onButtonClick = "deleteVehicle vehPreview;[false] spawn life_fnc_vehicleShopBuyCop;";
		...
		class BuyCar : life_RscButtonMenu
		{
			idc = 12309;
			text = "$STR_Global_Buy";
			onButtonClick = "deleteVehicle vehPreview;[true] spawn life_fnc_vehicleShopBuyCop;";
