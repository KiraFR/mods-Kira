...
_ctrl ctrlCommit 0;
_ctrl ctrlSetStructuredText parseText format["<t size='0.9'>De : %1</t><br/><t size='1.1' align='center'>%2</t><br/><t size='1' align='left'>%3</t>",_NameEntreprise,_title,_message];
_ctrl ctrlSetBackgroundColor _colorBG;
_ctrl ctrlSetForegroundColor _colorFont;
diag_log str(xNextAds);
